...
import { ArrowLeft, ExternalLink, FolderGit2, Layers } from 'lucide-react'
...
function EmptyState() {
  return (
    <div className="mt-12 flex flex-col items-center gap-3 rounded-[20px] border border-dashed border-[#1A1A1A]/15 bg-white/40 px-6 py-20 text-center">
      <Layers className="h-8 w-8 text-[#1A1A1A]/30" aria-hidden="true" />
      <p className="text-sm font-medium text-[#1A1A1A]/50">Full stack projects are being added here soon.</p>
    </div>
  )
}
