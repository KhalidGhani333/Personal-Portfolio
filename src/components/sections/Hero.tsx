      ...
      <div className="relative flex flex-1 flex-col items-center justify-start px-4 pb-16 pt-24 sm:justify-center lg:hidden">
        ...
        >
          <div className="flex flex-col items-center gap-4">
            <FloatingCard className="w-full max-w-[200px] text-center sm:max-w-[220px]">
            ...
            <div className="relative w-full max-w-[min(92vw,420px)] aspect-[894/1116] sm:max-w-[380px] md:max-w-[320px]">
              <PortraitFigure style={{ filter: blurFilter }} className="absolute inset-0 h-full w-full" />
              <div className="pointer-events-none absolute inset-x-0 top-[70%] flex justify-center px-3 text-center">
                <motion.h1
                  variants={fadeUpBlur}
                  className="text-[26px] font-bold leading-[1.12] tracking-tight text-white drop-shadow-[0_2px_14px_rgba(0,0,0,0.6)] sm:text-3xl"
                >
                  AI Automation,
                  <br />
                  Applied Differently.
