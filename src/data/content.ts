...
export const FRONTEND_TONES: Array<[string, string]> = [
  ['#E8C200', '#8a6d00'],
  ['#3b82f6', '#1e3a8a'],
  ['#f97316', '#7c2d12'],
  ['#22c55e', '#14532d'],
...
export const FRONTEND_PROJECTS: GridProject[] = [
  {
...
export const FULL_STACK_PROJECTS: GridProject[] = [
  {
    name: 'Burney Boyz',
...
export const AI_PROJECTS: GridProject[] = [
  {
